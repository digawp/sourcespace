defmodule SourceSpaceWeb.Web do
  @moduledoc """
  ...
  def controller do
    quote do
      ...
      import SourceSpaceWeb.Gettext
    end
  end

  def view do
    quote do
      use Phoenix.View, root: "web/templates", namespace: SourceSpaceWeb
      ...
      import SourceSpaceWeb.Router.Helpers
      import SourceSpaceWeb.ErrorHelpers
      import SourceSpaceWeb.Gettext
    end
  end
